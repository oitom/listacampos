...
Class Empresa_Model extends CI_Model
{
	...
	public function search($inicio = 0, $limite = null, $order="", $class="")
	{
		$where = array();
	...
	public function searchJoin($tabela = null, $inicio = 0, $limite = null, $order="", $class="")
	{
		if($order=="")
			$order = "plano";
		if($class=="")
		...
		$empresa = $this->search($inicio, $limite, $order, $class);
		$i = 0;
	...
	public function like($parametro_especifico=null, $order="plano", $class="DESC")
	{
		if($order=="")
			$order = "plano";
		if($class=="")
		...
		$this->db->like('url', $parametro, 'after');
		$this->db->or_like('nome', $parametro, 'after');
		$this->db->or_like('descricao', $parametro, 'after');
		$this->db->or_like('telefone', $parametro, 'after');
		$this->db->or_like('whatsapp', $parametro, 'after');
		$this->db->or_like('email', $parametro, 'after');
		$this->db->or_like('site', $parametro, 'after');
		$this->db->or_like('facebook', $parametro, 'after');
		$this->db->or_like('instagram', $parametro, 'after');
		$this->db->or_like('logradouro', $parametro, 'after');
		$this->db->or_like('numero', $parametro, 'after');
		$this->db->or_like('bairro', $parametro, 'after');
		$this->db->or_like('complemento', $parametro, 'after');
		$this->db->or_like('cidade', $parametro, 'after');
		$this->db->or_like('estado', $parametro, 'after');
