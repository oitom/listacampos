...
class Home extends CI_Controller {
	...
	{	
		...
		$empresasPlano3 = $this->Empresas->search();
	...
	{	
		...
		{	
			...
			$empresasRandom = $this->EmpresasAleatorias->search();
		...
		if(isset($nomeCategoria))
		{
			switch ($nomeCategoria) {
				...
				case 'compras':
					...
					$subcategorias = array("Selecione...", "Bebê e Gestante", "Bijouterias", "Boutiques", "Brinquedos", "Calçados", "Cama", "CD/DVD", "Floricultura", "Jóias", "Lingerie", "Livrarias", "Lojas", "Magazines", "Malharias", "Materiais esportivos", "Meias", "Mesa e Banho", "Móveis", "Otica", "Perfumaria", "Pijama", "Presentes", "Relógio", "Selarias", "Shoppings", "Outros");
